...
{
    public partial class InvGoodsReceivedNoteFromPurchaseOrderDocumentDetail
    {
        ...
        public decimal XQuantityOrdered { get; set; }
        ...
        public string XGrirNumber { get; set; }
        public decimal? XToleranceQty { get; set; }
