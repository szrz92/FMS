#pragma checksum "C:\Users\BA Tech\source\repos\sosfms\Client\Components\ActiveComplaintsCount.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "83c610fe38263d5c8ee91a267009f6418a7f43f7"
// <auto-generated/>
...
#nullable disable
    public partial class ActiveComplaintsCount : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.AddMarkupContent(0, @"<div class=""col-xl-12""><div class=""card card-custom bgi-no-repeat card-stretch gutter-b"" style=""background-position: right top; background-size: 30% auto; background-image: url(assets/media/svg/shapes/abstract-1.svg)""><div class=""card-body""><span class=""card-title font-weight-boldest text-dark font-size-h3-xl d-block""><b class=""float-left"">Active Complaints</b>
                <b class=""float-right"">40</b></span>
            <img class=""mt-6 d-block"" src=""icons/activecomplaint.png"" height=""32"">
            <br>
            <span class=""font-weight-bold font-size-sm"">Since last month</span></div></div></div>");
        }
